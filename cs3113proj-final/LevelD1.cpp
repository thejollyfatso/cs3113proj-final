...
void LevelD1::initialise()
{
    ...
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL6_DATA, map_texture_id, 1.0f, 20, 12);
    ...
    */
    ...
    hb_scale = { 1.9f, 1.2f, 1.0f };
    hb_offset = { 1.0f, 0.0f, 0.0f };
...
void LevelD1::update(float delta_time)
{
...
void LevelD1::render(ShaderProgram *g_shader_program)
{
