            ...
            case SDL_KEYDOWN:
                ...
                case SDLK_x:
					...
					case SDLK_SPACE:
                        ...
                        if (g_current_scene == g_level_d2 && g_level_d2->post_level_switch) switch_to_scene(g_level_d3);
                        if (g_current_scene == g_level_d3 && g_level_d3->post_level_switch) switch_to_scene(g_level_0);
                        break;
