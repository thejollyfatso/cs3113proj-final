...
void LevelD3::initialise()
{
    ...
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL8_DATA, map_texture_id, 1.0f, 20, 12);
...
void LevelD3::update(float delta_time)
{
...
void LevelD3::render(ShaderProgram *g_shader_program)
{
