...
void LevelD2::initialise()
{
    ...
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL7_DATA, map_texture_id, 1.0f, 20, 12);
    ...
    */
    ...
    hb_scale = { 0.6f, 1.2f, 1.0f };
    hb_offset = { -0.54f, -0.6f, 0.0f };
...
void LevelD2::update(float delta_time)
{
...
void LevelD2::render(ShaderProgram *g_shader_program)
{
